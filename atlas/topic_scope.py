...
OUT_OF_SCOPE: dict[str, str] = {
    "en": (
        ...
        "(all ATLAS layers, including fire / radiation / GNSS integrity / jamming / traffic), "
    ...
    "ru": (
        ...
        "(все слои ATLAS, включая пожары / радиацию / целостность GNSS / глушение / трафик), "
    ...
    "es": (
        ...
        "(todas las capas ATLAS, incl. fuego / radiación / integridad GNSS / jamming / tráfico), "
    ...
    "fr": (
        ...
        "(toutes les couches ATLAS, y compris feu / radiation / intégrité GNSS / brouillage / trafic), "
