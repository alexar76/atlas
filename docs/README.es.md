...
**Docs:** [EN](GUIDE.md) · [RU](i18n/GUIDE.ru.md) · [ES](i18n/GUIDE.es.md) · [FR](i18n/GUIDE.fr.md) · [ZH](i18n/GUIDE.zh.md) · **[Leyenda del mapa](i18n/LEGEND.es.md)**
...
Las capacidades de pago se contabilizan (`ATLAS_PAYMENT_ENFORCED=1`) y hay dos maneras de
llegar a ellas. Un llamante anónimo tiene un límite gratuito — cinco invokes por hora, por
`X-AIMarket-Sandbox-Visitor` o por su dirección. Quien necesite más mantiene una **cuenta de
crédito prepago** y envía su clave en `X-API-Key`: se le cobra el precio publicado por llamada,
queda exento del límite y nunca paga por un rechazo. La respuesta de pago trae
`X-Atlas-Credit-Charged-Usd` / `-Balance-Usd`, y además `-Low: 1` cuando el saldo baja a
`ATLAS_CREDITS_LOW_BALANCE_USD` (por defecto $1.00) o menos.

Completo, en cinco idiomas: [**CREDIT-ACCOUNTS**](i18n/CREDIT-ACCOUNTS.es.md) ·
[EN](CREDIT-ACCOUNTS.md) · [RU](i18n/CREDIT-ACCOUNTS.ru.md) · [FR](i18n/CREDIT-ACCOUNTS.fr.md) ·
